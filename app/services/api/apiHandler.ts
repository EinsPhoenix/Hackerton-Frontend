    ...
    if (response) {
      switch (response.status) {
        ...
        case 404:
          ...
          console.log("Couldn't find user. Please create an Account");
          console.log(translate(response.data, en))
          break
        case 419:
          logger.error('Session Expired:', response.data)
