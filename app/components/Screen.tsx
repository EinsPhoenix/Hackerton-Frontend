...
import { ExtendedEdge, isIOS, useSafeAreaInsetsStyle } from 'app/utils'
...
function useAutoPreset(props: AutoScreenProps): {
  ...
  /**
   * @param {number} _w - The width of the content.
 ...
 * @returns {React.ReactNode} - The rendered `ScreenWithoutScrolling` component.
 */
function ScreenWithoutScrolling(props: ScreenProps): React.ReactNode {
 ...
 * @returns {React.ReactNode} - The rendered `ScreenWithScrolling` component.
 */
function ScreenWithScrolling(props: ScreenProps): React.ReactNode {
  const {
    children,
 ...
 * @returns {React.ReactNode} The rendered `Screen` component.
 */
export function Screen(props: ScreenProps): React.ReactNode {
  const { appTheme, colors } = useColor()
  ...
  return (
    <View
      ...
      <StatusBar style={statusBarStyle || appTheme || 'dark'} {...StatusBarProps} />
